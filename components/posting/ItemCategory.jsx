...
function ItemCategory({isOwner}) {

    // const [selectedTag, setSelectedTag] = useState(-1); // 태그선택 안 된 상태
    const {
        selectedTag,
        setSelectedTag,
    ...
    return (
        <Container>
            <Title>
                <TitleLabel>
                {titleText}<Text style={{color: COLORS.red, fontSize: RFValue(13), fontWeight: 500}}> (택1/필수)</Text>
                </TitleLabel>
            </Title>
            <TagContainer>
