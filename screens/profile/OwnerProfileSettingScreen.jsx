...
function OwnerProfileSettingScreen() {
  ...
  const { shop_name, profile, introduction, opening_time, closing_time } = route.params;

  const [changedNickname, setNickname] = useState(shop_name);
  ...
  const onPressFinishBtn = () => {
    ...
    patchUserModify(data)
      ...
      .catch((err) => {
        ...
        console.log(changedIntroduction);
  ...
  return (
    <Container>
      <OwnerTopTab nickname={shop_name} profile={profile} />
      <Info>
        ...
        <MarketTimeChangeInfo
          changedStartTimeString={changedStartTimeString}
          changeEndTimeString={changeEndTimeString}
